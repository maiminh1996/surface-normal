...
PYBIND11_MODULE(surface_normal, m) {
  ...
  m.def("normals_from_depth", &normals_from_depth_imgfile_wrapper, py::arg("depth_in_path"), py::arg("normals_out_path"), py::arg("intrinsics"), py::arg("window_size") = 15, py::arg("max_rel_depth_diff") = 0.1, py::arg("use_cuda") = USE_CUDA);

  m.def("normals_from_depth_numpy", &normals_from_depth_numpy_wrapper, py::arg("depth"), py::arg("intrinsics"), py::arg("window_size") = 15, py::arg("max_rel_depth_diff") = 0.1, py::arg("use_cuda") = USE_CUDA);
